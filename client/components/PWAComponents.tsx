...
export const PWAInstallPrompt: React.FC = () => {
  const { showInstallPrompt, installApp, dismissInstallPrompt, isInstallable } =
    usePWA();
  ...
  return (
    <div className="fixed bottom-2 sm:bottom-4 left-2 sm:left-4 right-2 sm:right-4 sm:left-auto sm:right-4 sm:max-w-sm bg-white border border-gray-200 rounded-lg shadow-lg p-3 sm:p-4 z-50 animate-slideUp mobile-modal portrait-modal landscape-modal safe-area-bottom">
      <div className="flex items-start space-x-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Install this app on your device for better performance and offline
            access.
          </p>
...
export const PWAPanel: React.FC<{ isOpen: boolean; onClose: () => void }> = ({
  isOpen,
  onClose,
}) => {
  const { isInstallable, isInstalled, isOffline, isSupported, installApp } =
    usePWA();
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`text-sm font-medium ${isSupported ? "text-green-600" : "text-red-600"}`}
                >
                  {isSupported ? "Yes" : "No"}
                </span>
              </div>
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className={`text-sm font-medium ${isInstalled ? "text-green-600" : "text-gray-600"}`}
                  >
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600">Status:</span>
                <span
                  className={`text-sm font-medium ${isOffline ? "text-red-600" : "text-green-600"}`}
                >
              ...
              {isOffline && (
                <p className="text-xs text-gray-500 mt-2">
                  App continues to work offline. Data will sync when connection
                  is restored.
                </p>
              )}
            </div>
